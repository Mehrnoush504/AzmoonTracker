        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamsCreatedNum = table.Column<int>(type: "int", nullable: true),
                    ExamsLeftNum = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamName = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Questions", x => new { x.QuestionNum, x.ExamId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamId = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ChoiceNum = table.Column<int>(type: "int", nullable: false),
                    ChoiceDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsCorrect = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Choices", x => new { x.ChoiceNum, x.QuestionId, x.ExamId });
                    table.ForeignKey(
